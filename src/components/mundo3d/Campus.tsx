...
const AULAS_POR_FILA = 4;
const ESPACIADO_COLUMNA = 9;
const ESPACIADO_FILA = 11;
const Z_PRIMERA_FILA = 6;

function posicionAula(indice: number): [number, number, number] {
...
export const Campus: React.FC<{ aulas?: AulaCampus[] }> = ({ aulas = [] }) => {
